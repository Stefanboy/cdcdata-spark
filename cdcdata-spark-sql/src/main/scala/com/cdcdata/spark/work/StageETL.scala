 ...
 * /home/hadoop/lib/cdcdata-spark-core-1.0.jar \
...
object StageETL {
  ...
  def etlJson(spark:SparkSession): Unit ={
    ...
    accessDSStr.write.format("parquet").mode(SaveMode.Overwrite).save("cdcdata-spark-sql/out")
